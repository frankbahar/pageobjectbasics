...
public class TopMenu {
	...
	public AccountsPage gotoAccounts() {
		 ...
		 * "body.crmBodyWin:nth-child(2) div.newTopbar:nth-child(14) crm-menu.newMenuTable div.crmMenuLeft:nth-child(1) crm-tab:nth-child(5) div.lyteMenuItems:nth-child(2) div.lyteItem:nth-child(4) > a:nth-child(1)"
		 * )) .click();
		 */

package com.frankbahar.listeners;
...
import com.frankbahar.utilities.MonitoringMail;
import com.frankbahar.utilities.TestConfig;
...
public class CustomListeners extends Page implements ITestListener, ISuiteListener{
	...
	public void onFinish(ITestContext context) {
		...
		try {
			messageBody = "http://" + InetAddress.getLocalHost().getHostAddress() + ":8080/job/LiveProject%20-%20PageObjectModel/HTML_20Report/";
